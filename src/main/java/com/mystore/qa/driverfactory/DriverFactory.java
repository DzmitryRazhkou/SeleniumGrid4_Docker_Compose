...
//            Google Chrome:
            ...
            case "chrome-grid" -> {
                ...
                chromeOptions.addArguments("--window-size=1470, 790");
...
//            Firefox Mozilla:
            ...
            case "firefox-grid" -> {
                ...
                driver = new RemoteWebDriver((new URL("http://localhost:4445")), ffGridOptions);
            ...
            case "edge-grid" -> {
                ...
                driver = new RemoteWebDriver((new URL("http://localhost:4445")), edgeOptions);
                System.out.println(" =====> Selenium Edge Grid <===== ");
            }
